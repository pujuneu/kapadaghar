    ...
    <div class="container mx-auto py-8">
        ...
        <div class="flex">
            ...
            <div class="w-1/2">
                ...
                <p>Email: <a href="mailto:kapdaaghar@gmail.com">kapdaaghar@gmail.com</a> </p>
        ...
        <form class="mt-4">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Send
                Message</button>
        </form>
    </div>
@endsection
