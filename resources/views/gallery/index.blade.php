...
@section('content')
 ...
 <div class="my-4 text-right px-10">
    <a href="{{route('gallery.create')}}" class="bg-amber-400 text-black px-4  py-2 rounded-lg shadow-md
    hover:shadow-amber-300">Add Gallery</a>
 </div>
 ...
 <table id="mytable" class="display">
    ...
    <tbody>
      ...
      <tr>
         ...
         <td>
                <a href="{{route('gallery.edit',$gallery->id)}}" class="bg-blue-600 text-white px-2 py-1 rounded
                 shadow hover:shadow_blue-400">Edit</a>

                   {{-- <a onclick="return confirm('Are you sure to delete?')" href="{{route('gallery.destroy',$gallery->id)}}" class="bg-red-600 text-white px-2 py-1 rounded
