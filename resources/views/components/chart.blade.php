<div>
    ...
    <div>
        ...
        <div class="container mx-auto px-4 py-8">
            <canvas id="myLineChart" class="w-full h-96 mt-4"></canvas>
        </div>
    ...
    <script>
        ...
        const totalProfitData =
            @json($profits); // Replace with your total profit data for each day of the month
        const totalOrdersData =
            @json($ordercount); // Replace with your total orders data for each day of the month
